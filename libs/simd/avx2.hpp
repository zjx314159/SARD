...
size_t
intersect_vector_avx2(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2, uint32_t *result) {
...
size_t
intersect_vector_avx2_asm(const uint32_t *list1, size_t size1, const uint32_t *list2, size_t size2, uint32_t *result) {
    size_t count = 0, i_a = 0, i_b = 0;
    size_t st_a = (size1 / 8) * 8;
    size_t st_b = (size2 / 8) * 8;
